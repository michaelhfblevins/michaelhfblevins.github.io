...
const highlight_p = "mb-0 text-[1rem] sm:text-[1.2rem] text-ink"
const section_subtitle = "mb-4 font-heading text-[1.25rem] sm:text-[1.3rem] font-semibold tracking-[0.04em] text-accent-2 sm:text-[1.3rem]"
const step_list = "list-none grid gap-3"
const step_list_li = "relative pl-[26px] text-[1rem] sm:text-[1.2rem] text-ink before:content-['—'] before:absolute before:left-0 before:text-accent"
